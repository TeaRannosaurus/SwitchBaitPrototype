...
public class PlayerController : MonoBehaviour {
	...
	void FixedUpdate()
	{
		if (_pState == PlayerState.WALK)
		{
			...
			_rb.velocity = new Vector3(Mathf.Lerp(0, Input.GetAxis("Horizontal" + playerID) * walkSpeed, 0.8f), 0.0f, Mathf.Lerp(0, Input.GetAxis("Vertical" + playerID) * walkSpeed, 0.8f));
		}
	}
}